...
namespace ServiceStack.Text.Tests.JsonTests
{
        ...
        : TestBase
    {
        ...
        [Test]
        public void Can_deserialize_nested_dict_with_slash_at_end_of_value()
        {
            const string json = "{ \"Model\" : { \"Id\" : 1, \"Name\" : \"String with slashes\\\\\" } }";
            var fromJson = JsonSerializer.DeserializeFromString<Dictionary<string, Dictionary<string, string>>>(json);
            Assert.That(fromJson["Model"]["Name"], Is.EqualTo("String with slashes\\"));
        }
